...
#define DRJIT_USE_LLVM
    ...
    using BoolJit =     drjit::DiffArray<JitBackend::LLVM, bool>;
    using FloatJit =    drjit::DiffArray<JitBackend::LLVM, float>;
    using Int32Jit =    drjit::DiffArray<JitBackend::LLVM, int32_t>;
    using Int64Jit =    drjit::DiffArray<JitBackend::LLVM, int64_t>;
    using UInt32Jit =   drjit::DiffArray<JitBackend::LLVM, uint32_t>;
    using UInt64Jit =   drjit::DiffArray<JitBackend::LLVM, uint64_t>;
#elif defined(DRJIT_USE_CUDA)
    using BoolJit =     drjit::DiffArray<JitBackend::CUDA, bool>;
    using FloatJit =    drjit::DiffArray<JitBackend::CUDA, float>;
    using Int32Jit =    drjit::DiffArray<JitBackend::CUDA, int32_t>;
    using Int64Jit =    drjit::DiffArray<JitBackend::CUDA, int64_t>;
    using UInt32Jit =   drjit::DiffArray<JitBackend::CUDA, uint32_t>;
    using UInt64Jit =   drjit::DiffArray<JitBackend::CUDA, uint64_t>;
#endif
#else
#if defined(DRJIT_USE_LLVM)
